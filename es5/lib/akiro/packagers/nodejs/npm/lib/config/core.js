...
Object.defineProperty(exports, 'defaults', { get: function get() {
    return configDefs.defaults;
  }, enumerable: true });

Object.defineProperty(exports, 'types', { get: function get() {
...
function load() {
  ...
  for (var i = 0; i < arguments.length; i++) {
    switch (typeof arguments[i]) {
      case 'string':
        builtin = arguments[i];break;
      case 'object':
        cli = arguments[i];break;
      case 'function':
        cb = arguments[i];break;
    }
  }
