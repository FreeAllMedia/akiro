...
;(function () {
  ...
  var cmdList = ['install', 'install-test', 'uninstall', 'cache', 'config', 'set', 'get', 'update', 'outdated', 'prune', 'pack', 'dedupe', 'rebuild', 'link', 'publish', 'star', 'stars', 'tag', 'adduser', 'logout', 'unpublish', 'owner', 'access', 'team', 'deprecate', 'shrinkwrap', 'help', 'help-search', 'ls', 'search', 'view', 'init', 'version', 'edit', 'explore', 'docs', 'repo', 'bugs', 'faq', 'root', 'prefix', 'bin', 'whoami', 'dist-tag', 'ping', 'test', 'stop', 'start', 'restart', 'run-script', 'completion'];
  var plumbing = ['build', 'unbuild', 'xmas', 'substack', 'visnup'];
  ...
  Object.keys(abbrevs).concat(plumbing).forEach(function addCommand(c) {
    Object.defineProperty(npm.commands, c, { get: function get() {
        if (!loaded) {
  ...
  function defaultCb(er, data) {
    log.disableProgress();
    if (er) console.error(er.stack || er.message);else console.log(data);
  }
    ...
    which(process.argv[0], function (er, node) {
      ...
      npmconf.load(cli, builtin, function (er, config) {
        ...
        switch (color) {
          ...
          default:
            var tty = require('tty');
            if (process.stdout.isTTY) npm.color = true;else if (!tty.isatty) npm.color = true;else if (tty.isatty(1)) npm.color = true;else npm.color = false;
            break;
        }
  ...
  Object.defineProperty(npm, 'root', { get: function get() {
      return npm.dir;
    } });

  Object.defineProperty(npm, 'cache', { get: function get() {
  ...
  Object.getOwnPropertyNames(npm.commands).forEach(function (n) {
    ...
    Object.defineProperty(npm, n, { get: function get() {
        return function () {
          var args = Array.prototype.slice.call(arguments, 0);
          var cb = defaultCb;
